...
import me.unknkriod.ang.databinding.ActivityRoutingEditBinding
...
class RoutingEditActivity : BaseActivity() {
    ...
    private fun setupOutboundTagInput() {
        ...
        val suggestions = (AppConfig.BUILTIN_OUTBOUND_TAGS.toList() + profileRemarks).distinct()
    ...
    private fun clearServer(): Boolean {
        ...
        binding.spOutboundTag.setText(AppConfig.BUILTIN_OUTBOUND_TAGS.first(), false)
        return true
    }
    ...
    private fun saveServer(): Boolean {
        ...
        rulesetItem.apply {
            ...
            outboundTag = binding.spOutboundTag.text.toString().trim().ifEmpty { AppConfig.TAG_PROXY }
        }
