...
object AppConfig {
    ...
    const val APP_URL = "$GITHUB_URL/UnknKriod/UnknMagic"
    val APP_API_URL = BuildConfig.UPDATE_URL
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/UnknKriod/UnknMagic/master/CR.md"
    ...
    const val MSG_STATE_PAUSE = 8
    const val MSG_STATE_RESUME = 9
