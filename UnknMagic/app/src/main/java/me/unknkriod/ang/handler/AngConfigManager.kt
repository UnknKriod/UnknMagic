...
import me.unknkriod.ang.fmt.CustomFmt
import me.unknkriod.ang.fmt.Hysteria2Fmt
import me.unknkriod.ang.fmt.ShadowsocksFmt
import me.unknkriod.ang.fmt.SocksFmt
import me.unknkriod.ang.fmt.TrojanFmt
import me.unknkriod.ang.fmt.VlessFmt
import me.unknkriod.ang.fmt.VmessFmt
import me.unknkriod.ang.fmt.WireguardFmt
import me.unknkriod.ang.util.HttpUtil
import me.unknkriod.ang.util.JsonUtil
import me.unknkriod.ang.util.LogUtil
import me.unknkriod.ang.util.QRCodeDecoder
...
object AngConfigManager {
    ...
    private fun parseConfig(
        ...
        try {
            ...
            } else if (str.startsWith(EConfigType.HYSTERIA2.protocolScheme) || str.startsWith(
                    AppConfig.HY2
                )) {
