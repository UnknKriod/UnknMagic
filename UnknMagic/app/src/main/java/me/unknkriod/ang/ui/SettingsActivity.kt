...
import me.unknkriod.ang.AppConfig.VPN
import me.unknkriod.ang.R
import me.unknkriod.ang.handler.MmkvManager
import me.unknkriod.ang.helper.MmkvPreferenceDataStore
...
//            localDnsPort?.isEnabled = enabled
        ...
        private fun updateEnableLocalProxy(enabled: Boolean) {
            ...
            if (!enabled) {
                ...
                val vpn = MmkvManager.decodeSettingsString(AppConfig.PREF_MODE) == AppConfig.VPN
                appendHttpProxy?.isEnabled = vpn
            }
        }
