...
import me.unknkriod.ang.AppConfig.DEFAULT_PORT
import me.unknkriod.ang.AppConfig.PREF_ALLOW_INSECURE
import me.unknkriod.ang.AppConfig.WIREGUARD_LOCAL_ADDRESS_V4
import me.unknkriod.ang.AppConfig.WIREGUARD_LOCAL_MTU
...
import me.unknkriod.ang.handler.AngConfigManager
import me.unknkriod.ang.handler.MmkvManager
import me.unknkriod.ang.handler.SettingsChangeManager
...
class ServerActivity : BaseActivity() {
    ...
    private val createConfigType by lazy {
        EConfigType.Companion.fromInt(intent.getIntExtra("createConfigType", EConfigType.VMESS.value))
            ?: EConfigType.VMESS
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sp_stream_security?.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(
                ...
                val isTLS = streamSecuritys[position] == AppConfig.TLS
    ...
    private fun saveServer(): Boolean {
        ...
        val config =
            MmkvManager.decodeServerConfig(editGuid) ?: ProfileItem.Companion.create(createConfigType)
