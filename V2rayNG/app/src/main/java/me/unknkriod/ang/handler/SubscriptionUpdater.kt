...
object SubscriptionUpdater {
     ...
     */
    fun sync(
        context: Context = AngApplication.Companion.application,
     ...
     */
    fun syncOne(context: Context = AngApplication.Companion.application, subId: String) {
     ...
     */
    fun cancelOne(context: Context = AngApplication.Companion.application, subId: String) {
